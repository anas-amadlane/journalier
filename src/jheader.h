...
#  define BL_SP "CREATE UNIQUE INDEX IF NOT EXISTS BL_%s_DATE_NUM ON BL_%s ( DATE, NUM );"
#  define BLC "CREATE VIEW IF NOT EXISTS BLC_VIEW_%s AS SELECT t1.*, (SELECT CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END FROM BL_%s) AS QTE_CORR, (SELECT t2.TVA FROM BL_%s t1 JOIN MAT t2 ON t1.FAMILLE = t2.Code_Famille) AS TVA, (SELECT CASE WHEN TYPE = 'MR' THEN REMISE/100 ELSE 0 END FROM BL_%s) AS REMISE, (SELECT CASE WHEN TYPE = 'MR' THEN ((PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) / (1 - (REMISE/100))) - (PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) ELSE 0 END FROM BL_%s) AS REMISE_TTC, (SELECT PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END) FROM BL_%s) AS CA_TTC, (SELECT (PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) / (1 + (SELECT t2.TVA FROM BL_%s t1 JOIN MAT t2 ON t1.FAMILLE = t2.Code_Famille)) FROM BL_%s) AS CA_HT, (SELECT (PRIX_GROS * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) / (1 + (SELECT t2.TVA FROM BL_%s t1 JOIN MAT t2 ON t1.FAMILLE = t2.Code_Famille)) FROM BL_%s) AS MNT_HT, (SELECT ((PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) / (1 + (SELECT t2.TVA FROM BL_%s t1 JOIN MAT t2 ON t1.FAMILLE = t2.Code_Famille))) + (CASE WHEN TYPE = 'MR' THEN ((PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) / (1 - (REMISE/100))) - (PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) ELSE 0 END) FROM BL_%s) AS CA_BRUT, (SELECT (((PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) / (1 + (SELECT t2.TVA FROM BL_%s t1 JOIN MAT t2 ON t1.FAMILLE = t2.Code_Famille))) + (CASE WHEN TYPE = 'MR' THEN ((PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) / (1 - (REMISE/100))) - (PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) ELSE 0 END)) - ((PRIX_GROS * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) / (1 + (SELECT t2.TVA FROM BL_%s t1 JOIN MAT t2 ON t1.FAMILLE = t2.Code_Famille))) FROM BL_%s) AS MARGE_BRUT, (SELECT ((((PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) / (1 + (SELECT t2.TVA FROM BL_%s t1 JOIN MAT t2 ON t1.FAMILLE = t2.Code_Famille))) + (CASE WHEN TYPE = 'MR' THEN ((PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) / (1 - (REMISE/100))) - (PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) ELSE 0 END)) - ((PRIX_GROS * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) / (1 + (SELECT t2.TVA FROM BL_%s t1 JOIN MAT t2 ON t1.FAMILLE = t2.Code_Famille)))) / (((PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) / (1 + (SELECT t2.TVA FROM BL_%s t1 JOIN MAT t2 ON t1.FAMILLE = t2.Code_Famille))) + (CASE WHEN TYPE = 'MR' THEN ((PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) / (1 - (REMISE/100))) - (PRIX_VENTE * (CASE WHEN TYPE = 'avo' THEN -QTE ELSE QTE END)) ELSE 0 END)) FROM BL_%s) AS MARGE, (SELECT t2.Type_Clt_Site FROM BL_%s t1 JOIN CLT t2 ON t1.CODE_PHAR = t2.CODE_Client_Site) AS TYPE_CLT, (SELECT t2.Désignation_Famille FROM BL_%s t1 JOIN MAT t2 ON t1.FAMILLE = t2.Code_Famille) AS NOM_FAM, (SELECT t2.Famille_Marge FROM BL_%s t1 JOIN MAT t2 ON t1.FAMILLE = t2.Code_Famille) AS FAM_MARGE FROM BL_%s t1;"
